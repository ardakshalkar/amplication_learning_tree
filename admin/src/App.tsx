...
import { CompletionIndex } from "./completion/CompletionIndex";
import { TrackIndex } from "./track/TrackIndex";
  ...
  return (
    <>
      <Menu
        ...
        logoContent={
          <Link to="/">
            <CircleBadge name={"Learning Tree"} />
          </Link>
        }
      ></Menu>
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute path="/items" component={ItemIndex} />
            <PrivateRoute path="/completions" component={CompletionIndex} />
            <PrivateRoute path="/tracks" component={TrackIndex} />
          </Switch>
        </Page>
      </MainLayout.Content>
    </>
